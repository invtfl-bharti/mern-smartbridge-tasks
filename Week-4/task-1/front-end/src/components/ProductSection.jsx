  ...
  const products = [
    {
      ...
      price: 299.99,
      description:
        "Noise-cancelling wireless headphones with superior sound quality and 20-hour battery life. Featuring premium materials and the latest purpletooth technology.",
    ...
    },
    {
      ...
      price: 89.99,
      description:
        "Compact, waterproof, and powerful purpletooth speaker with 360° sound. Perfect for outdoor adventures with 12 hours of playtime.",
            ...
            <div key={product.id} className="group relative">
              ...
              <div className="">
                <button
                  ...
                  className="mt-2 w-full bg-purple-600 text-white py-2 px-4 rounded hover:bg-purple-700 cursor-pointer"
                >
                  View Details
                </button>
              </div>
